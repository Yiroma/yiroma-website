  ...
  return (
    <main className="mx-auto max-w-3xl px-6 py-20 lg:px-12">
      ...
      <section className="mb-10">
        ...
        <p className="text-muted-foreground leading-relaxed">
          Le site peut utiliser des cookies pour améliorer l&apos;expérience utilisateur et réaliser
          des statistiques de visite. Vous avez la possibilité de refuser l&apos;utilisation des
          cookies lors de votre première visite via un bandeau d&apos;information.
        </p>
        <p className="text-muted-foreground mt-3 leading-relaxed">
      ...
      <section className="mb-10">
        ...
        <p className="text-muted-foreground leading-relaxed">
          Romaric YI s&apos;efforce d&apos;assurer l&apos;exactitude des informations diffusées sur
          ce site. Toutefois, il ne peut être tenu responsable des erreurs ou omissions. Le
          Prestataire décline toute responsabilité pour les dommages directs ou indirects pouvant
          résulter de l&apos;accès ou de l&apos;utilisation du site, y compris en cas de virus
          informatique ou de tout autre dommage au matériel informatique.
        </p>
      </section>
      ...
      <section className="mb-10">
        ...
        <p className="text-muted-foreground mt-3 leading-relaxed">
          Toute création de lien hypertexte vers ce site doit faire l&apos;objet d&apos;une
          autorisation préalable et écrite de Romaric YI.
        </p>
      </section>
      ...
      <section>
        ...
        <ul className="text-muted-foreground space-y-1 leading-relaxed">
          ...
          <li>Page &laquo;&nbsp;services&nbsp;&raquo; : en cours</li>
          <li>Page &laquo;&nbsp;portfolio&nbsp;&raquo; : en cours</li>
          <li>Page &laquo;&nbsp;tarifs&nbsp;&raquo; : en cours</li>
          <li>Page &laquo;&nbsp;contact&nbsp;&raquo; : en cours</li>
        </ul>
      </section>
    </main>
  );
